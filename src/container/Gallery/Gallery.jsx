  ...
  return (
    <div className="app__gallery flex__center">
      ...
      <div className="app__gallery-content">
        ...
        <p className="p__opensans" style={{ color: "#AAA", marginTop: "2rem"}}>Turpis cursus in hac habitasse, platea dictumst quisque. Sagittis purus sit amet volutpat consequat mauris nunc congue.</p>
